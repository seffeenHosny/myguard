...
@section('title', trans('admin.contact_reasons'))
@section('content')
<div class="row">
    <div class="col-md-12">
        <!--begin::Card-->
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">
                        {{trans('admin.contact_reasons')}}
                    </h4>
                </div>
            </div>
            <a href="{{route('contact_reasons.create')}}" class="btn btn-text-primary font-weight-bold btn-fixed" data-palcement="top" data-toggle="tooltip" title="{{trans('admin.add-contact_reason')}}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="flex align-items-center list-user-action">
                                        <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="{{trans('admin.edit')}}" data-original-title="Edit" href="{{route('contact_reasons.edit' , $item->id)}}">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        {!! Form::open(['method'=>'delete' , 'route'=>['contact_reasons.destroy' ,$item->id] , 'class'=>'d-inline']) !!}
