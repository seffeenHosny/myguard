...
<div class="sign-in-from">
    ...
    @endif
    <form class="mt-4" method="POST" action="{{ route('company.post.login') }}">
        @csrf
        ...
        <div class="d-inline-block w-100 text-center mt-5 ">
            <a href="{{ route('company.register') }}">تسجيل حساب جديد</a>
        </div>
    </form>
</div>
@endsection
